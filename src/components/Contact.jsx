...
import Resume from '../assets/Shwetank_Resume.pdf';
    ...
    return (
        <motion.div className="contactpage pulse max-w-3xl mx-auto p-6 rounded-2xl mt-10 duration-500" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <div className="resume">
                <motion.a href={Resume} download="Shwetank_Resume.pdf" className="w-full bg-blue-500 text-white py-2 px-4 rounded-md font-medium hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 mt-5 text-center inline-block" whileTap={{ scale: 0.95 }} >
                    Download my Resume
                </motion.a>
            </div>
        </motion.div>
